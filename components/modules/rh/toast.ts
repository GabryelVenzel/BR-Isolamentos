...
// Mesmo sistema de toast mínimo dos outros módulos (ver
// components/modules/operacional/toast.ts) — duplicado aqui de propósito,
// não importado de lá: cada módulo mantém seus componentes autocontidos, sem
